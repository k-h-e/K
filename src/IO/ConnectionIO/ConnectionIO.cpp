...
ConnectionIO::ConnectionIO(const shared_ptr<IoBuffers> &ioBuffers, const shared_ptr<ThreadPool> &threadPool) {
    ...
    worker_      = make_shared<Worker>(fileDescriptors[0], sharedState_, ioBuffers);
