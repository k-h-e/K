...
#ifndef K_IO_FRAMEWORK_CONNECTION_SYNCHRONIZEDSTATE_H_
#define K_IO_FRAMEWORK_CONNECTION_SYNCHRONIZEDSTATE_H_
...
class Connection::SynchronizedState : public virtual IO::ConnectionIO::ClientInterface {
  public:
    SynchronizedState(const std::shared_ptr<Core::Framework::RunLoop> &runLoop, int bufferSizeConstraint);
...
#endif    // K_IO_FRAMEWORK_CONNECTION_SYNCHRONIZEDSTATE_H_
